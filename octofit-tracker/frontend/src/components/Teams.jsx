...
export default function Teams() { return <Resource resource={teamsEndpoint} title="Teams" render={(team) => <><strong>{team.name}</strong><span>{team.members?.length ?? 0} members</span></>} /> }
